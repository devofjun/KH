...
import service.StudentConsultFormService;
import service.StudentConsultInsertService;
import service.StudentConsultListService;
...
public class StudentFrontController extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		commandMap.put("StudentConsultList.kh", new StudentConsultListService());
		commandMap.put("StudentConsultForm.kh", new StudentConsultFormService());
		commandMap.put("StudentConsultInsert.kh", new StudentConsultInsertService());
	}
